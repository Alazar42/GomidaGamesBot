from telegram.ext import ApplicationBuilder, CommandHandler, filters, MessageHandler, ConversationHandler, CallbackQueryHandler
...
app = ApplicationBuilder().token(str(getenv("BOT_TOKEN"))).build()
